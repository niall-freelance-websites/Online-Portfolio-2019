	...
	<table class="help-opt">
		...
		<tr>
			...
			<td>
				...
				When this action is selected the dup-database__<?php echo $GLOBALS['DUPX_AC']->package_hash;?>.sql file found inside the dup-installer folder of the archive.zip file will NOT be ran.   The database your connecting to should already
