...
<!--	<div class="hdr-sub3">
	...
	<div class="s4-go-back">
		...
		<ul style="margin-top: 1px">
			<li>Review and test the <a href="<?php echo $url_new_rtrim; ?>" target="_blank">front-end</a> for this site.</li>
			<li>
				Login into the WordPress Admin and remove all
		...
		<ul style="margin-top: 1px">
			...
			<li>Rerun the installer from <a href="<?php echo "{$url_new_rtrim}/installer.php"; ?>">step 1</a></li>
		</ul>
	</div>
